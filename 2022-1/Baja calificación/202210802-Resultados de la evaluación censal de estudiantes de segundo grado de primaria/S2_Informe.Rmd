...
DT16 <- DT16
DT15 <- DT15
M_Region<- sample(c("SUR","NORTE","ORIENTE", "LIMA","CENTRO"), size =dim(DT16)[1], replace = TRUE)
...
## **Factibilidad:**
En este estudio nos enfocaremos en los estudiantes de segundo grado de primaria,de acuerdo a como van los  resultados que se obtuvieron en el censo del año 2015 y 2016 se podrá tener una visión más clara de como van los estudiantes en cada distritos.

## **Objetivo:**
Objetivo: Mostrar que regiones del Perú obtuvieron un bajo rendimiento académico en el Censo Estudiantil que se dio en el 2016  y a la vez compararlas con los resultados del 2015
...
Población : Todos los estudiantes  que rindieron la evaluación Censal de Estudiantes  en el año 2016 y 2015.
...
```
### **Macro Región vs promedio de Matemática** 
```{r,echo = FALSE}
...
legend(x = "top", legend = c("Media = 587", "Nota de Nivel satisfactorio >638"), fill = c("red", "blue"), 
       title = )
```
### **Macro Región vs promedio de Lectura** 

```{r,echo = FALSE}

boxplot(DT16$Medida.Promedio.en.Lectura  ~ DT16$M_Region, xlab="Macro Regiones", ylab = "Promedio en Lectura", col = 5)
abline (h = mean(DT16$Medida.Promedio.en.Lectura), col = 'red', lwd = 2)
abline (h = 583, col = 'blue', lwd = 2)
legend(x = "top", legend = c("Media = 561", "Nota de Nivel satisfactorio >583"), fill = c("red", "blue"), 
       title = )
```



### **Evolución de la cobertura de estudiantes entre los años 2015 y 2016**
...
Descriptores Numéricos      |        2015            |       2016            | 
----------------------------|------------------------|-----------------------|
Media                       |       95.65            |         96.75         |
Mediana                     |      96.4              |         97.6          |
Rango                       |       20               |         20            |
Varianza                    |       16.41            |        12.56          |
Desviación Estándar         |       4.05             |        3.54           |
Rango Intercuartil       	  |      	5.45             |        4.9            |
...
### **Promedio de lectura VS Promedio de Matemática en el 2015 y 2016**
...
calcular_pnorm<-function(archivo,numero){
  round(1-pnorm(numero,median(archivo),sd(archivo)),2)
}
```

#### **Comparamos la probabilidad de los estudiantes en satisfactorio Lectura en los años 2015 y 2016**
```{r,eval=FALSE,echo=FALSE}
round(calcular_pnorm(DT16$Medida.Promedio.en.Lectura,583),2)
round(calcular_pnorm(DT15$Medida.Promedio.en.Lectura,583),2)
```
...
### **Variable: Medida Promedio en Matemática de los años 2015 y 2016**
...
#### **Comparamos la probabilidad de los estudiantes en satisfactorio Matemática en los años 2015 y 2016**
